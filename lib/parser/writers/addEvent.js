...
var roleIdMap = {
  "battle": 15,
  "birth": 16,
  "construction closing": 21,
  "construction commencement": 22,
  "construction opening": 23,
  "death": 24,
  "organisation extinction": 25,
  "organisation foundation": 26,
  "place dissolution": 27,
  "place foundation": 28
};

var roleImportanceIdMap = {
  "battle": 11,
  "birth": 12,
  "construction closing": 13,
  "construction commencement": 14,
  "construction opening": 15,
  "death": 16,
  "organisation extinction": 17,
  "organisation foundation": 18,
  "place dissolution": 19,
  "place foundation": 20
};
...
var eventParticipantInsert = _.template(
  ...
  "VALUES (<%= thing_id %>, <%= event_id %>, <%= role_id %>, <%= importance_id %>, 1)"
);
    ...
    return db.runQuery(insert).then(function (result) {
      ...
      if (job.value.id || job.value.placeId) {
        var insert = eventParticipantInsert({
          ...
          event_id: eventId,
          role_id: roleIdMap[eventType],
          importance_id: roleImportanceIdMap[eventType]
        });
        job.log(insert);
