...
var getRoleFilterString = function (params) {
  var filterString = "";
  if (params.roleFilters && params.roleFilters.length > 0) {
    filterString += "(event_participant.role_id not in (" + params.roleFilters.join(", ") + "))";
  }
  return filterString;
};
...
var getEventTypeFilterString = function (params) {
  var filterString = "";
  if (params.eventTypeFilters && params.eventTypeFilters.length > 0) {
    filterString += "(event.type_id not in (" + params.eventTypeFilters.join(", ") + "))";
  }
  return filterString;
};
