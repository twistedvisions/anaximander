...
var groupEventByParticipant = function (eventArray) {
  ...
  event.start_date = moment(event.start_date.getTime() - event.start_date.getTimezoneOffset() * 60 * 1000);
  event.end_date = moment(event.end_date.getTime() - event.end_date.getTimezoneOffset() * 60 * 1000);
