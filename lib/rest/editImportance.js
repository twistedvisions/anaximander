...
ImportanceEditor.prototype.checkUserPermissions = function () {
  if (!this.permissions["edit-importance"]) {
    throw new Error("User lacks 'edit-importance' permission");
  }
};
...
ImportanceEditor.prototype.getImportance = function (id, typeId) {
  ...
  db.runQueryInTransaction(
    ...
    _.bind(function (result) {
      this.originalImportance = result.rows[0];
      d.resolve();
    }, this),
    d.reject
  );
...
ImportanceEditor.prototype.saveImportanceChanges = function (importanceId, values) {
  ...
  var oldImportance = _.pick(this.originalImportance, _.keys(newImportance));
...
module.exports = {
  init: function (app) {
    ...
    app.put("/importance", function () {
      var importanceEditor = new ImportanceEditor();
      importanceEditor.call.apply(importanceEditor, arguments);
    });
  },
