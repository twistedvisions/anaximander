...
EventEditor.prototype.ensureNewParticipants = function (participants) {
  return sequence([
    _.bind(this.ensureParticipantTypesAndImportances, this,
        participants, this.params.typeId || this.originalEvent.typeId),
    _.bind(function () {
      //todo: do as sequence
      when.map(participants, _.bind(function (participant) {
        return this.ensureParticipant(
          participant, false,
          this.params.typeId || this.originalEvent.typeId
        );
      }, this));
    }, this)
  ]);
