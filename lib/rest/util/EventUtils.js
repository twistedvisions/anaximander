...
EventUtils.prototype.ensureParticipantImportances = function (participants) {
  ...
  var newImportances = this.aggregateNewImportances(participants);
  var existingImportances = this.aggregateExistingImportances(participants);

  return sequence([

    _.bind(function () {
      return sequence(_.map(newImportances, this.ensureNewImportances, this));
    }, this),

    _.bind(function () {
      return sequence(_.map(existingImportances, this.ensureExistingImportances, this));
    }, this)
  ]);
};

EventUtils.prototype.aggregateNewImportances = function (participants) {
  var newImportances = {};
...
EventUtils.prototype.aggregateExistingImportances = function (participants) {
...
EventUtils.prototype.ensureNewImportances = function (participantMap/*, typeId*/) {

  return _.bind(function () {
    return sequence(
      _.map(participantMap, function (participantList) {
        return _.bind(this.ensureNewImportance, this, participantList);
      }, this)
...
EventUtils.prototype.ensureNewImportance = function (participantList) {
...
EventUtils.prototype.ensureExistingImportances = function (participant) {
  return _.bind(function () {
    //todo: refactor to not take map?
