...
EventUtils.prototype.ensureParticipantTypes = function (participants, eventTypeId) {
  ...
  return sequence([
    _.bind(function () {
      return sequence(_.map(newRoles, function (typeList) {
    ...
    _.bind(function () {
      return sequence(_.map(existingRoles, function (type) {
        return _.bind(function () {
          //todo: refactor to not take map?
...
EventUtils.prototype.ensureParticipantImportances = function (participants) {
  ...
  //todo: instead of the below, ensure that new types have default nominal importances set.

  // _.bind(function () {
  //   if (participant.hasNewType) {
  //     delete participant.hasNewType;
  //     //this means the default importance might not be nominal??
