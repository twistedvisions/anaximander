    ...
    StyledIcon = function (styledIconType, styledIconOptions, styleClass) {
      ...
      function gs_() {
        ...
        ge_.addDomListenerOnce(simage_, "load", function () {
          ...
          me.set(sw_, new gmi_(styledIconType.getShadowURL(me), null, null,
            styledIconType.getShadowAnchor(me, w, h)));
          simage = null;
        });
        ge_.addDomListenerOnce(image_, "load", function ()  {
          var w = image_.width, h = image_.height;
          me.set(i_, new gmi_(styledIconType.getURL(me), null, null,
            styledIconType.getAnchor(me, w, h)));
    ...
    */
    ...
    StyledIconTypes.MARKER = {
      ...
      getShape: function (props, width, height) {
        ...
        for (var i = 0; i < _iconmap.coord.length; i += 1) {
